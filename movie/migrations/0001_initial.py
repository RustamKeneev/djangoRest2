# Generated by Django 3.1.5 on 2021-01-31 12:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('world_primiere', models.DateField(default=datetime.date.today, verbose_name='Примьера в мире')),
                ('budjet', models.PositiveSmallIntegerField(default=0, help_text='указать сумму в долларах', verbose_name='Бюджет')),
                ('fess_in_usa', models.PositiveSmallIntegerField(default=0, help_text='указать сумму в долларах', verbose_name='Сборы в США')),
                ('fess_in_world', models.PositiveSmallIntegerField(default=0, help_text='указать сумму в долларах', verbose_name='Сборы в мире')),
                ('url', models.SlugField(max_length=256, unique=True)),
                ...
                ('directors', models.ManyToManyField(related_name='film_director', to='movie.Actor', verbose_name='режисер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=128, verbose_name='Имя')),
                ('text', models.TextField(max_length=8000, verbose_name='Сообщение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ip', models.CharField(max_length=16, verbose_name='IP адресс')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie.movie', verbose_name='фильм')),
